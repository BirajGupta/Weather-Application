...
const Switch = styled.label`
  ...
  transition: 0.4s;
  border-radius: 55px;
  background-color: ${({ theme }:{theme : any}) => theme.temperatureSwitch.backgroundColor};
  .on,
  .off {
    color: ${({ theme }:{theme : any}) => theme.temperatureSwitch.textColor};
    position: absolute;
...
const Slider = styled.div`
  ...
  left: 2px;
  top: 2px;
  background-color: ${({ theme }:{theme : any}) => theme.temperatureSwitch.sliderColor};
